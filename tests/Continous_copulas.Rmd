...
In this markdown the goal is to build on the previous markdown showcasing the trivial copula implementation of a gaussian copulas with two gaussian maginals. Here I want to extend this into a gaussian copula with non-gaussian maginals.
